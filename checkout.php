...
<html>
<head>
<title>Queen Dimsum - Checkout</title>
<!-- for-mobile-apps -->
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="Queen Dimsum, Dclicious" />
	...
	<div class="agileits_header">
		<div class="container">
			<div class="w3l_offers">
				<p>DAPATKAN PENAWARAN MENARIK KHUSUS HARI INI, ORDER SEKARANG!</p>
			</div>
	...
	<div class="logo_products">
		...
		<div class="w3ls_logo_products_left1">
				<ul class="phone_email">
					<li><i class="fa fa-phone" aria-hidden="true"></i>Hubungi Kami :(+62) 881 0265 87132 </li>
				</ul>
			</div>
			<div class="w3ls_logo_products_left">
				<h1><a href="index.php">Queen Dimsum</a></h1>
			</div>
...
<!-- checkout -->
	<div class="checkout">
		<div class="container">
			<h1>Terima kasih, <?=$_SESSION['name']?> telah membeli <?php echo $itungtrans3 ?> makanan di Queen Dimsum </Q></span></h1>
...
<div class="footer">
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>PT. Queen Dimsum, Indonesia</li>
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:info@email">queendimsum@gmail.com</a></li>
						<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>(+62) 881 0265 87132</li>
					</ul>
				</div>
				<div class="col-md-3 w3_footer_grid">
					...
					<ul class="info"> 
						...
						<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="https://wa.me/62881026587132">Hubungi Kami</a></li>
					</ul>
				</div>
				<div class="clearfix"> </div>
			</div>
		...
		<div class="footer-copy">
			...
			<div class="container">
				<p>© 2022 Queen Dimsum. All rights reserved</p>
			</div>
		</div>
			...
			<div class="container">
				<div class="w3layouts-foot">
					<ul>
						...
						<li><a href="https://instagram.com/miniequeen.id?igshid=YmMyMTA2M2Y="><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
						
					</ul>
				</div>
				<div class="payment-w3ls">	
					<img src="images/app.jpeg" alt=" " class="img-responsive">
				</div>
				<div class="clearfix"> </div>
			</div>
		</div>
